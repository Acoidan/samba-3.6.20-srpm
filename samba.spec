...
Source: https://ftp.samba.org/pub/samba/%{name}-%{samba_version}%{pre_release}.tar.gz
...
%changelog
* Wed Jul 19 2017 Nico Kadel-Garcia <nkadel@gmail.com> - 3.6.25-0.1
- Update to 3.6.25

%changelog
* Thu Jan  9 2014 Nico Kadel-Garcia <nkadel@gmail.com> - 3.6.22-0.1
- Update to 3.6.22
